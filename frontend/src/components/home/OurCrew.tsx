      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/[0.03] border border-slate-900/5 mb-6 backdrop-blur-sm"
          >
            <HiOutlineUserGroup className="w-5 h-5 text-primary-600" />
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-primary-600">The Dream Team</span>
          </motion.div>
          ...
          >
            Meet Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 via-purple-600 to-pink-500">Crew</span>
          </motion.h2>
          ...
          <motion.p 
            ...
            className="text-slate-500 max-w-2xl mx-auto text-base md:text-lg leading-relaxed font-outfit"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {crew.map((member, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative flex flex-col justify-between h-[480px] rounded-3xl bg-white border border-slate-100 hover:border-primary-500/30 overflow-hidden transition-all duration-500 shadow-lg hover:shadow-2xl hover:shadow-slate-200/50"
            >
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-100 flex items-center gap-3">
                    {member.contact && (
                      <a 
                        ...
                        className="w-9 h-9 rounded-xl bg-slate-50 border border-slate-200/60 flex items-center justify-center text-slate-400 hover:text-white hover:bg-primary-600 hover:border-primary-500 transition-all duration-300"
                    ...
                    {member.instagram && (
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer" 
                        className="w-9 h-9 rounded-xl bg-slate-50 border border-slate-200/60 flex items-center justify-center text-slate-400 hover:text-white hover:bg-pink-600 hover:border-pink-500 transition-all duration-300"
                        title="Instagram"
                      >
